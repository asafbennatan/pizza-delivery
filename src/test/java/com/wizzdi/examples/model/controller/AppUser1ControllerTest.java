...
@ActiveProfiles("test")
public class AppUser1ControllerTest {
  ...
  public void testAppUserCreate() {
    ...
    ResponseEntity<AppUser> response =
        this.restTemplate.postForEntity("/AppUser1/createAppUser", request, AppUser.class);
  ...
  public void testListAllAppUsers() {
    ...
    ResponseEntity<PaginationResponse<AppUser>> response =
        this.restTemplate.exchange(
            "/AppUser1/getAllAppUsers", HttpMethod.POST, new HttpEntity<>(request), t);
    Assertions.assertEquals(200, response.getStatusCodeValue());
  ...
  public void testAppUserUpdate() {
    ...
    ResponseEntity<AppUser> response =
        this.restTemplate.exchange(
            "/AppUser1/updateAppUser", HttpMethod.PUT, new HttpEntity<>(request), AppUser.class);
    Assertions.assertEquals(200, response.getStatusCodeValue());
    testAppUser = response.getBody();
    assertAppUser(request, testAppUser);
  }

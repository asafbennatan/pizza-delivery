  ...
  private <T> Map<String, T> listByIds(
    ...
    try {
      ...
      if (idGetter != null) {
        ...
        com.wizzdi.examples.model.security.UserSecurityContext securityContextPrincipal =
            (com.wizzdi.examples.model.security.UserSecurityContext) securityContext.getPrincipal();

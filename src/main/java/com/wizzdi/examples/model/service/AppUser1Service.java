...
import com.wizzdi.examples.model.data.AppUserRepository;
import com.wizzdi.examples.model.model.AppUser;
import com.wizzdi.examples.model.model.AppUser_;
...
public class AppUser1Service {
  ...
  public AppUser createAppUserNoMerge(
    ...
    updateAppUser1NoMerge(appUser, appUserCreate);
   ...
   */
  public boolean updateAppUser1NoMerge(AppUser appUser, AppUserCreate appUserCreate) {
    ...
    if (appUserCreate.getFullAddress() != null
        && (!appUserCreate.getFullAddress().equals(appUser.getFullAddress()))) {
      appUser.setFullAddress(appUserCreate.getFullAddress());
      update = true;
    }
  ...
  public AppUser updateAppUser(AppUserUpdate appUserUpdate, UserSecurityContext securityContext) {
    ...
    if (updateAppUser1NoMerge(appUser, appUserUpdate)) {
      appUser = this.repository.merge(appUser);
    }
    return appUser;
  }

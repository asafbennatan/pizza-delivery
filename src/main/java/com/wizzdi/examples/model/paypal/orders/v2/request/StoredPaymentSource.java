...
public class StoredPaymentSource {
   ...
   */
  public <T extends StoredPaymentSource> T setPayment_initiator(
   ...
   * @return StoredPaymentSource
   */
  public <T extends StoredPaymentSource> T setPayment_type(
   ...
   * @return StoredPaymentSource
   */
  public <T extends StoredPaymentSource> T setUsage(StoredPaymentSourceUsageType usage) {
    this.usage = usage;
    return (T) this;
  }
   ...
   * @return StoredPaymentSource
   */
  public <T extends StoredPaymentSource> T setPrevious_network_transaction_reference(

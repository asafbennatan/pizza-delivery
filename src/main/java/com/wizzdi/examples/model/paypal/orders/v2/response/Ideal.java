...
public class Ideal {
   ...
   * @return Ideal
   */
  public <T extends Ideal> T setName(String name) {
    this.name = name;
    return (T) this;
  }
   ...
   * @return Ideal
   */
  public <T extends Ideal> T setCountry_code(String country_code) {
   ...
   * @return Ideal
   */
  public <T extends Ideal> T setBic(String bic) {
    this.bic = bic;
    return (T) this;
  }
   ...
   * @return Ideal
   */
  public <T extends Ideal> T setIban_last_chars(String iban_last_chars) {
   ...
   * @return Ideal
   */
  public <T extends Ideal> T setAttributes(Object attributes) {

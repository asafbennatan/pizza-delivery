...
public class JwtTokenFilter extends OncePerRequestFilter {
  ...
  public JwtTokenFilter(JwtTokenUtils jwtTokenUtils, AppUser1Service appUser1Service) {
  ...
  protected void doFilterInternal(
    ...
    if (id != null && SecurityContextHolder.getContext().getAuthentication() == null) {
      AppUser appUser = appUser1Service.getByIdOrNull(AppUser.class, AppUser_.id, id);
      if (appUser != null) {

...
import com.wizzdi.examples.runtime.security.JwtTokenFilter;
import com.wizzdi.examples.runtime.security.JwtTokenUtils;
                ...
                f.successHandler(
                    (request, response, authentication) -> {
                      ...
                      UserSecurityContext user =
                          new UserSecurityContext((customOAuth2User.getAppUser()));
                      String redirectUri =
                          clientRedirectUri + "token=" + jwtTokenUtils.generateAccessToken(user);

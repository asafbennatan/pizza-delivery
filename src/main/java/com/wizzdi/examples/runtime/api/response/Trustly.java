...
public class Trustly {
   ...
   * @return Trustly
   */
  public <T extends Trustly> T setName(String name) {
    this.name = name;
    return (T) this;
  }
   ...
   * @return Trustly
   */
  public <T extends Trustly> T setCountry_code(String country_code) {
   ...
   * @return Trustly
   */
  public <T extends Trustly> T setBic(String bic) {
    this.bic = bic;
    return (T) this;
  }
   ...
   * @return Trustly
   */
  public <T extends Trustly> T setIban_last_chars(String iban_last_chars) {

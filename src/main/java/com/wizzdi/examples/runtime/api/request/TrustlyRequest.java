...
public class TrustlyRequest {
   ...
   */
  public <T extends TrustlyRequest> T setName(String name) {
    this.name = name;
    return (T) this;
  }
   ...
   * @return TrustlyRequest
   */
  public <T extends TrustlyRequest> T setCountry_code(String country_code) {
   ...
   * @return TrustlyRequest
   */
  public <T extends TrustlyRequest> T setExperience_context(
